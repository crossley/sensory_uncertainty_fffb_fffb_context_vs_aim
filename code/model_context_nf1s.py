...
def simulate(params, args):
    ...
    for i in range(n_trials - 1):
        ...
        yff[i] = xff[i] + xff2[current_context, i]
        ...
        xff2[:, i + 1] = beta_ff * xff2[:, i]
        xff2[current_context, i + 1] += gamma_ff[sig_mp[i] - 1] * ff_adapt_mp
        xff2[current_context, i + 1] += gamma_ff[sig_ep[i] - 1] * ff_adapt_ep
        xff2[current_context, i + 1] += bias_ff
